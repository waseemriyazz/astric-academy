...
// ISO 3166-1 alpha-2 -> alpha-3 country code mapping. PayGlocal's
// paymentData.billingData.addressCountry field requires alpha-3; every other
// part of this app (frontend country picker, Easebuzz) uses alpha-2, so this
// table exists purely to bridge that one PayGlocal-specific requirement.
return [
    ...
    'MF' => 'MAF', 'RS' => 'SRB', 'SX' => 'SXM', 'SS' => 'SSD',
    // Kosovo has no official ISO 3166-1 code; XK/XKX is the widely used
    // user-assigned convention (matches the frontend's country picker).
    'XK' => 'XKX',
];
