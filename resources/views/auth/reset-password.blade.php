        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-4xl p-6 sm:p-10 shadow-card border border-ink-100/60">
                <div class="text-center mb-6">
                    <h2 class="font-display text-2xl font-bold text-ink-900 mb-1">Reset your password</h2>
                    <p class="text-ink-400 text-sm">Choose a new password for your account.</p>
                </div>
