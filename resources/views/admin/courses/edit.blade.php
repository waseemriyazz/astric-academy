...
<div class="max-w-4xl bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('admin.courses.index') }}" class="text-sm font-medium text-gray-500 hover:text-brand-600 transition">
    ...
    <form action="{{ route('admin.courses.update', $course->id) }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="title" required value="{{ old('title', $course->title) }}" class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">
            @error('title') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
        </div>
        
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
            <textarea name="description" rows="4" class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">{{ old('description', $course->description) }}</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="category" class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">
            ...
            <div>
                ...
                <input type="text" name="duration" value="{{ old('duration', $course->duration) }}" class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500" placeholder="e.g. 8 Weeks">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="icon_name" class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="tools_count" min="0" value="{{ old('tools_count', $course->tools_count ?? 0) }}" class="w-full pl-9 rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="price_min" step="0.01" min="0" value="{{ old('price_min', $course->price_min) }}" class="w-full pl-7 rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">
                </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="price_max" step="0.01" min="0" value="{{ old('price_max', $course->price_max) }}" class="w-full pl-7 rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500">
                </div>
        ...
        <div>
            ...
            <textarea name="features" rows="4" class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500" placeholder="e.g.&#10;Practical Strategies&#10;Real-world Tools">{{ old('features', is_array($course->features) ? implode("\n", $course->features) : $course->features) }}</textarea>
        ...
        <div class="flex justify-end gap-3 pt-6">
            <a href="{{ route('admin.courses.index') }}" class="px-5 py-2.5 bg-white border border-gray-300 rounded-2xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition">Cancel</a>
    ...
    <div class="mt-8 pt-8 border-t border-gray-200">
        <h3 class="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
            <i class="fas fa-certificate text-brand-600"></i> Certificate Configuration
        </h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="signature_name" 
                           value="{{ old('signature_name', $course->certificate_config['signature_name'] ?? 'Skill Stryx') }}" 
                           class="w-full rounded-2xl border-gray-300 focus:ring-brand-500 focus:border-brand-500"
