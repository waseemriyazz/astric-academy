...
<div class="max-w-2xl bg-white rounded-xl shadow-[0_2px_10px_rgb(0,0,0,0.02)] border border-gray-100 p-8">
    ...
    <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="question" required value="{{ old('question', $faq->question) }}" class="w-full rounded-lg border-gray-200 focus:ring-blue-500 focus:border-blue-500 transition shadow-sm">
        ...
        <div>
            ...
            <textarea name="answer" rows="4" required class="w-full rounded-lg border-gray-200 focus:ring-blue-500 focus:border-blue-500 transition shadow-sm">{{ old('answer', $faq->answer) }}</textarea>
        ...
        <div>
            ...
            <input type="number" name="sort_order" min="0" value="{{ old('sort_order', $faq->sort_order) }}" class="w-full rounded-lg border-gray-200 focus:ring-blue-500 focus:border-blue-500 transition shadow-sm">
