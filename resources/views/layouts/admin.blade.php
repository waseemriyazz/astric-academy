...
<body class="font-sans antialiased bg-[#FAFAFA] flex h-screen overflow-hidden text-sm">
    ...
    <!-- Sidebar -->
    <aside class="w-64 bg-white text-gray-600 flex flex-col h-full shadow-[2px_0_10px_rgba(0,0,0,0.03)] border-r border-gray-100 z-20 transition-all duration-300" aria-label="Admin navigation sidebar">
        ...
        <header class="h-[72px] bg-white border-b border-gray-200 flex items-center justify-between px-6 lg:px-8 shadow-sm shrink-0">
            ...
            <div class="flex items-center justify-end gap-5 sm:gap-8 flex-1">
                ...
                <div class="relative hidden lg:block w-72">
                    ...
                    <input type="text" class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 transition-all placeholder-gray-400 focus:bg-white" placeholder="Search students, courses, email..." aria-label="Search students, courses, or email">
                </div>

                <!-- Notifications -->
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="relative text-gray-500 hover:text-blue-600 transition" aria-label="Toggle notifications dropdown">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        ...
                        <div class="flex items-center text-sm text-gray-500 mt-1">
                            ...
                            <i class="fas fa-chevron-right text-xs mx-2 text-gray-400" aria-hidden="true"></i>
                            <span class="text-gray-900 font-medium">@yield('header')</span>
                        </div>
                    </div>
                    
                    <!-- Optional action button area for specific pages -->
